  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: MaterialApp(
        ...
        theme: ThemeData.light(useMaterial3: true), // Ensure correct theme setup
        home: const LogoP(),
        onGenerateRoute: (settings) => AppRoute().OnGenerateRoute(settings), // Ensure correct routing setup
      ),
    );
  }
}
